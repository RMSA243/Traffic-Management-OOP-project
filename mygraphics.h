...
void drawEllipse(double x1, double y1, double x2, double y2, int R, int G, int B); // draws a rectangle-bounded ellipse using top-left and bottom-right x-y coordinates with a border using RGB colouring
void drawEllipse(double x1, double y1, double x2, double y2, int R, int G, int B, int FR, int FG, int FB); // draw a rectangle-bounded ellipse using top-left and bottom-right x-y coordinates with separate border and fill colours
...
void drawEllipse(double x1, double y1, double x2, double y2, int R, int G, int B)
{
	drawEllipse(x1, y1, x2, y2, R, G, B, 0, 0, 0);
}

//void drawEllipse(int x1, int y1, int x2, int y2, int R, int G, int B, int FR, int FG, int FB)
void drawEllipse(double x1, double y1, double x2, double y2, int R, int G, int B, int FR, int FG, int FB)
{
	HWND consoleHandle = GetConsoleWindow();
	HDC deviceContext = GetDC(consoleHandle);
